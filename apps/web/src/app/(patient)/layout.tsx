    ...
    >
      <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <nav className="flex items-center gap-2">
          {/* Primary nav moves to the bottom tab bar on mobile (see PatientBottomNav) —
              this row only renders for pointer-driven, wide-viewport sessions. */}
  ...
  return (
    <PatientAuthProvider>
      <div className="flex min-h-screen flex-col bg-background">
        <PatientNav />
        <main className="mx-auto w-full max-w-5xl flex-1 px-4 pb-24 pt-8 sm:px-6 sm:py-8">{children}</main>
        {/* Hidden on mobile once the bottom tab bar takes over — see PatientBottomNav. */}
