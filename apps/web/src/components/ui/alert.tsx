...
const alertVariants = cva(
  "relative w-full rounded-lg border p-4 text-sm [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:h-4 [&>svg]:w-4 [&>svg~*]:pl-7 rtl:[&>svg]:left-auto rtl:[&>svg]:right-4 rtl:[&>svg~*]:pl-0 rtl:[&>svg~*]:pr-7",
  {
    variants: {
      variant: {
